...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      text: "Hello! I'm your Sachin. How can I help you today?",
      isBot: true,
      timestamp: new Date()
    }
  ])
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch('https://wheresachin.app.n8n.cloud/webhook/54dc5260-ccfc-4ce8-8b88-953fe5aba642/chat', {
        method: 'POST',
        headers: {
        ...
        <div className="fixed bottom-6 right-6 w-80 h-96 bg-white rounded-lg shadow-2xl border border-gray-200 z-50 flex flex-col">
          ...
          <div className="bg-blue-600 text-white p-4 rounded-t-lg flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">OneCart Support</span>
            </div>
            <button
